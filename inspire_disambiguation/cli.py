...
@click.option(
    ...
    help=f"Path for saving ethnicity model. (default: '{conf['ETHNICITY_MODEL_PATH']})'",
    type=str,
)
...
@click.option(
    ...
    default=conf["ETHNICITY_MODEL_PATH"],
    help=f"Path to ethnicity model obtained after training on ethnicity data. (default: '{conf['ETHNICITY_MODEL_PATH']}')",
    type=str,
)
@click.option(
    "-s",
...
@click.option(
    ...
    help=f"Size of sampled pairs. Has to be multiple of 12. (default:'{conf['SAMPLED_PAIRS_SIZE']}')",
    type=int,
)
