...
def curated_signature():
    signature = Signature(author_affiliation='Rutgers U., Piscataway', author_id=989440, author_name='Seiberg, Nana',
...
def non_curated_signature():
    signature = Signature(author_affiliation='Texas U.', author_id=None, author_name='Weinberg, Steven',
    ...
    return \
        {
            ...
            "record": {
                "$ref": "http://labs.inspirehep.net/api/authors/989441"
            },
            "affiliations": [
                {
                    "value": "Rutgers U., Piscataway"
                }
            ],
