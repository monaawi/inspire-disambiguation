...
from inspire_disambiguation.core.ml.models import load_signatures, get_author_full_name, get_first_initial, \
    get_second_initial, get_first_given_name, get_second_given_name, get_author_other_names, get_author_affiliation, \
    get_coauthors_neighborhood, get_abstract, get_keywords, get_collaborations, get_topics, get_title, \
    group_by_signature
...
def test_load_signatures(curated_signature, non_curated_signature):
    ...
    expected_signatures_by_uuid = {curated_signature["signature_uuid"]: curated_signature,
