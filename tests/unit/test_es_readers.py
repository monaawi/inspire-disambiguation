...
def test_get_lit_records_query_for_all():
    query = get_lit_records_query(None, False)
...
def test_get_lit_records_query_for_signature_block():
    query = get_lit_records_query(signature_block="BLOCK", only_curated=False)
    source = query._params["_source"]
    expected_query = {
        "query": {
            "bool": {
...
def test_get_lit_records_query_for_only_curated():
    query = get_lit_records_query(only_curated=True, signature_block=None)
    source = query._params["_source"]
    expected_query = {
        "query": {
            "bool": {
