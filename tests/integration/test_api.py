...
def test_train_and_save_distance_model(scan_mock, choices_mock, fit_mock, tmpdir, ethnicity_path, es_record_with_many_curated_authors):
    choices = [
...
# @patch("inspire_disambiguation.api.StrictRedis")
# def test_cluster_from_redis(redis_mock, cluster_mock):
#     redis_object_mock = MagicMock()
#     redis_object_mock.bzpopmin.side_effect = ['BLOCK_1', 'BLOCK_2', 'BLOCK_3', None]
#     redis_mock.from_url.side_effect = redis_object_mock
#     import pdb
#     pdb.set_trace()
